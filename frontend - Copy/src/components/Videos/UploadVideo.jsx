...
const UploadVideo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (metadataLoading) {
      toast.error('Video details are still being detected. Please wait a moment.');
      return;
    }
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            />
            <p className="text-xs text-dark-400 mt-1">
              Generated from the YouTube video ID
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-dark-700 mb-1">
                Duration (seconds, detected automatically)
              </label>
              <input
                type="number"
                name="duration"
                ...
                readOnly
                className="input-field bg-dark-50"
                placeholder={metadataLoading ? 'Detecting...' : 'Detected from YouTube'}
              />
            </div>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-blue-700">
                ...
                <p className="mt-1">
                  You'll earn from every view on your video. 
                  Revenue share starts at 65% and can increase up to 70%.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            {loading || metadataLoading ? (
              <span className="flex items-center justify-center">
                ...
                {metadataLoading ? 'Detecting video details...' : 'Sharing...'}
              </span>
            ) : (
              <span className="flex items-center justify-center">
